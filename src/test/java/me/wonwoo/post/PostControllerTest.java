...
public class PostControllerTest {
    ...
    public void editPost() throws Exception{
        ...
        PostDto poastDto = (PostDto) mvcResult.getModelAndView().getModel().get("editPost");
        assertThat(poastDto.getTitle()).isEqualTo("제목");
        assertThat(poastDto.getContent()).isEqualTo("컨텐츠");
        assertThat(poastDto.getCode()).isEqualTo("마크다운");
    }
